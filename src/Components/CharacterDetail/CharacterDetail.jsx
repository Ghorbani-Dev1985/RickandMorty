...
const CharacterDetail = (props) => {
    const {image , name , gender ,  status , species , location} = props.characterDetails
    console.log(props.characterEpisodes)
  return (
   <>
<div className="w-full flex flex-col items-center text-white bg-gray-800 border border-gray-600 rounded-lg shadow md:flex-row mb-8">
    <img className="object-cover w-full rounded-t-lg h-full md:h-auto md:w-72 md:rounded-none md:rounded-s-lg" src={image} alt="" />
    ...
    <div className='flex text-orange-500 font-bold my-2'>
        ...
        <h2 className="mb-2 text-2xl font-bold tracking-tight text-orange-500 dark:text-white">{name}</h2>
                    </div>
...
<li>
<a href="#" className="flex items-center p-3 text-base font-bold rounded-lg bg-slate-700 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
