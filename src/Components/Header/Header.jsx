        ...
        <div className="bg-gray-800 border border-gray-600 flex-between rounded-xl my-6 p-2">
          ...
          <div className="flex flex-col items-center gap-2">
            <input
              ...
              type="text"
              className="rounded-full h-14 dark:focus:text-white outline-none text-white dark:text-gray-600 placeholder:text-slate-500 dark:placeholder-gray-600 w-48 focus:w-64 border border-transparent hover:border-gray-200 dark:border-gray-700 dark:focus:border-gray-600 bg-gray-700 text-base placeholder:text-lg pl-14 pr-5 block transition-all"
              placeholder="search..."
            />
          ...
          >
            ...
            <span className="bg-rose-500 font-sans text-white size-6 pt-2 flex-center rounded-full absolute -top-2 -right-1">
              {favorites.length}
            </span>
          </button>
        </div>
